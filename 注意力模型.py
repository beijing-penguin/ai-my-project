...
class bilstm_attn(torch.nn.Module):
    def __init__(self, batch_size, output_size, hidden_size, vocab_size, embed_dim, bidirectional, use_cuda, attention_size, sequence_length):
    ...
    def forward(self, input_sentences, batch_size=None):
        ...
        return logits
aa = bilstm_attn(1,512,10,1,111,True,False,111,111)
print(aa)
aa.forward(torch.rand(3, 4, 512))